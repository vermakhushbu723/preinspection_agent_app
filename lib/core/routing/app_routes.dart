...
class AppRoutes {
  ...
  static const String inspectionDetails = '/preinspection-agent/inspection-details';
  ...
  static const String cameraCapture = '/preinspection-agent/camera-capture/:angle';
  static String cameraCapturePath(String angle) =>
      '/preinspection-agent/camera-capture/$angle';

  static const String walkAroundVideo = '/preinspection-agent/walk-around-video';
  static const String addDamagePhotos = '/preinspection-agent/add-damage-photos';
  static const String addOthersPhotos = '/preinspection-agent/add-others-photos';
  ...
  static const String repairSubmission = '/preinspection-agent/repair-submission';
